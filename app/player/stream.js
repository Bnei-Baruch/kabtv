(function () {
    ...
    Stream.$inject = ['PlayerDataService', '$routeParams', 'config', '$translate', 'streamObj'];


    function Stream(PlayerDataService, $routeParams, config, $translate, streamObj) {
        var vm = this;
        var timerObj;

        vm.streamObj = streamObj;
        vm.currentPlayerLang = $routeParams.mediaLang || config.lang;
